        ...
        <div class="col-md-10 offset-md-1">
            <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group mt-3">
                    ...
                    <textarea type="text" rows="4" class="form-control" placeholder="Enter product description" name="description"></textarea>
                </div>
                ...
                <button class="btn btn-primary px-5 py-1 mx-auto d-block">Create</button>
            </form>
        </div>
    </div>
</div>
